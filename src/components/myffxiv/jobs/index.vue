<template>
    <div class="flex flex-col">
        ...
        <div class="bg-white px-4 py-3 flex items-center justify-between border-t border-gray-200 sm:px-6">
            ...
            <nav class="relative z-0 inline-flex justify-end sm:rounded-t-none rounded-b-lg shadow-sm -space-x-px" aria-label="Pagination">
                ...
                <a v-for="(p, i) in numberOfPages" :key="i" @click="changePage(i+1)" aria-current="page" :class="page === i+1 ? 'bg-indigo-50' : ''" class="bg-white border-gray-300 text-gray-500 hover:bg-gray-50 relative inline-flex items-center px-4 py-2 border text-sm font-medium">
                    {{i+1}}
                </a>
